...
var MobileField = function MobileField(_ref) {
	...
	return checkoutField && order.mobile !== '' ? _react2.default.createElement(ShippingFieldDiv, {
...
var CityField = function CityField(_ref2) {
	...
	return checkoutField && order.shipping_address.city !== '' ? _react2.default.createElement(ShippingFieldDiv, {
		label: helper.getCheckoutFieldLabel(checkoutField),
...
var CommentsField = function CommentsField(_ref3) {
	...
	return checkoutField && order.comments !== '' ? _react2.default.createElement(ShippingFieldDiv, {
		label: helper.getCheckoutFieldLabel(checkoutField),
...
var OrderItems = function OrderItems(_ref7) {
	...
	if (items && items.length > 0) {
		var rows = items.map(function (item) {
			return _react2.default.createElement(OrderItem, { key: item.id, item: item, settings: settings });
		});
		return _react2.default.createElement(
			'div',
			null,
	...
	if (order && order.items && order.items.length > 0) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement('img', { src: '/assets/images/success.svg', alt: '' }),
				_react2.default.createElement('br', null),
...
CheckoutSuccess.propTypes = {
	...
	pageDetails: _propTypes2.default.shape({}).isRequired,
	shippingMethod: _propTypes2.default.shape({}).isRequired,
	checkoutFields: _propTypes2.default.arrayOf(_propTypes2.default.shape({})).isRequired
};
